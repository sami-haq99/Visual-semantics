...
def draw_bar_chart(input_json_path, output_pdf_path, identifier):
    ...
    for testset, languages in results.items():
        ...
        ax.set_ylabel(f"{identifier} Score", fontsize=12)
        ...
        fig.savefig(output_pdf_path + f"{testset}_{identifier}.pdf", format='pdf')


# Example usage
input_json_path = "/home/sami/mmt-eval/doc-mte/MDPI Experiments/data/chrf_scores.json"
output_pdf_path = "/home/sami/mmt-eval/doc-mte/MDPI Experiments/data/"

draw_bar_chart(input_json_path, output_pdf_path, identifier="CHARF")